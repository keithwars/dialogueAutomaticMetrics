...
# This is the Repetition Measurement module. It is an external script contibuting to the main class of the combined component. It loads 3 main functions, mainly the Internal Repetition, External Repetition and Partner Repetition checker. The imports necessary for the correct execution of this script are listed under the Imports header block.  The following parts load the models, consecutively. Each function receives as input either a response (internal), a statement and a response (partner) or a history and response (external). As output, a dataframe and a percentage of repetition for each of the cases is given.
...
class checkRepetitionInternal():
    ...
    #**************************************************************************************/
    #    Title: ParlAI
    #    Author: Facebook Research Labs
    #    Date: 2019
    #    Code version: #1802
    #    Availability: https://github.com/facebookresearch/ParlAI/blob/master/projects/controllable_dialogue/controllable_seq2seq/controls.py
    #**************************************************************************************/
...
# ### Partner Repetition Check

# In[7]:

class checkRepetitionPartner():
    
    #Code blocks used from Reference Code: 001*
...
# ### Old Code - Used Initially For Testing
# Refer only for transitive development and historic progress.
